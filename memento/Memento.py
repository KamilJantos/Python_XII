...
def main():
    ...
    # obsługa stanów menu - zad 3.3.1
    while True:
        print('------------------------------------------------')
        print('1. Quote 1 |==| 2. Quote 2 |==| 3. Add Quote')
        print()
        key = input('Choose option: ')
        if key == '1':
            print()
            print('Select option :')
            print('1. Author |==| 2. Restore')
            key = input('Choose option: ')
            if key == '1':
            ...
            print('Select option :')
            print('1. Fix |==| 2. Fix again |==| 3. Restore')
            key = input('Choose option: ')
            ...
            qa = input('Insert your own quote: ')
            qb = input('Insert author of this quote:')
            q3 = Quote(qa, qb)
            print(f'New Quote: {qa}, author: {qb}')
        else:
            print(f'unknown option: {key}')
